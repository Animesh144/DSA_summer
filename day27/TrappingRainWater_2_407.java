...
public class TrappingRainWater_2_407 {
    public static void main(String[] args){
        ...
        for(int i=0;i<n;i++){
            for(int j=0;j<m;j++){
                heightMap[i][j] = read.nextInt();
            }
        }
        int result = TrappingRainWater_2_Solution(heightMap);
        System.out.println(result);
        read.close();
    }
    public static int TrappingRainWater_2_Solution(int[][] heightMap){
